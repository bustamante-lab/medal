...
gpanels <- pheatmap(as.dist(d), #cutree_cols = k, cutree_rows = k,
                    scale="none",
                    show_colnames = TRUE,
                    show_rownames = TRUE,
                    #drop_levels  = TRUE,
         ...
         #annotation_colors = recode(kmeans$cluster, "1"="#e8a631", "2"="#ca3542", "3"="#00a572", "4"="#0080ff"),
         cluster_rows = TRUE,
         cluster_cols = TRUE)

ggexport(gpanels, filename=here("images", "Figure2-c-heatmap.png"), height = 2800, width = 3000, res=300)
